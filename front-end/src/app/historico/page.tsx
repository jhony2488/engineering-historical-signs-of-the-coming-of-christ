    ...
    <>
      ...
      >
        <ChipGroup
          ...
          value={janela}
          onChange={setJanela}
          ariaLabel="Selecionar janela temporal do histórico"
        />
        ...
        {loading ? (
          ...
          <div className="space-y-6 stagger-grid">
            ...
            <section className="card-interactive overflow-x-auto" aria-labelledby="historico-records-title">
              <h3 id="historico-records-title" className="card-title">Registros — {motorMeta?.label}</h3>
              <table className="w-full text-sm" aria-labelledby="historico-records-title">
                <caption className="sr-only">Registros históricos — {motorMeta?.label}</caption>
                <thead>
                  <tr className="text-left text-xs text-slate-500 border-b border-ink-700">
                    ...
                    <th scope="col" className="pb-2 pr-4 text-right">Índice</th>
                    <th scope="col" className="pb-2 pr-4 text-right">Confiança</th>
                    <th scope="col" className="pb-2">Transição</th>
