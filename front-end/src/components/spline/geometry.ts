...
export function clampPoint(point: Point, size = SCENE_SIZE): Point {
...
export function lateralPoint(side: LateralSide, size = SCENE_SIZE): Point {
...
export function footerCenterPoint(size = SCENE_SIZE): Point {
...
export function pointFromMouse(clientX: number, clientY: number, size = SCENE_SIZE): Point {
  return clampPoint(
    {
